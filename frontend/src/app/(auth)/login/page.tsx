...
export default function LoginPage() {
  ...
  return (
    <div className="space-y-6 bg-white/60 dark:bg-zinc-900/60 backdrop-blur-xl p-8 rounded-3xl border border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.1)]">
      <div className="text-center space-y-2">
        <h1 className="text-3xl font-bold tracking-tight bg-gradient-to-br from-zinc-900 to-zinc-600 dark:from-white dark:to-zinc-400 bg-clip-text text-transparent">Welcome Back</h1>
        <p className="text-sm text-zinc-500">Sign in to access the internbot demo</p>
      </div>
      ...
      <p className="text-center text-sm font-medium text-zinc-500">
        ...
        <Link href="/register" className="text-blue-500 hover:text-blue-600 hover:underline transition-colors">
          Create one
        </Link>
      </p>
    </div>
